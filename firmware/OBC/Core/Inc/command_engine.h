...
extern char command_response[50];
...
typedef struct command_response_queue {
	int cmd_id;
	char response[200];
...
extern QueueHandle_t command_execution_response_queue;

/* tasks */
extern TaskHandle_t command_engine_receive_command_task_handle;
extern TaskHandle_t command_engine_command_processor_task_handle;
